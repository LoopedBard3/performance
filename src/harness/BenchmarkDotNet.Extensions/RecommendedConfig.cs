...
namespace BenchmarkDotNet.Extensions
{
    public static class RecommendedConfig
    {
            ...
            bool getDiffableDisasm = false)
        {
            if (job is null)
            {
                #pragma warning disable CS0618 // WithEvaluateOverhead is obsolete but needed for overhead calculation
                job = Job.Default
                    ...
                    .WithEvaluateOverhead(Environment.GetEnvironmentVariable("PERFLAB_EVALUATE_OVERHEAD") == "1") // subtract method-call invocation overhead when enabled
